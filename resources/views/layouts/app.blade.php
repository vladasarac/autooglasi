  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          @if (Auth::check() && Auth::user()->role == 'admin')
            <ul class="main-nav nav navbar-nav navbar-right">
              <li class="wow fadeInDown" data-wow-delay="0s"><a class="{{ Request::is('/') ? 'active' : '' }}" href="/">Početna</a></li>
              ...
              <li class="wow fadeInDown" data-wow-delay="0.4s"><a class="{{ Request::is('adminoglasi') ? 'active' : '' }}" href="{{ url('/adminoglasi') }}">Oglasi</a></li>
          ...
          {{--linkovi ako je ulogovani user obican korisnik tj. NIJE admin--}}
            <ul class="main-nav nav navbar-nav navbar-right">
              ...
              @if (Auth::check() && Auth::user()->role == 'author'&& Auth::user()->aktivan == 1)
                <li class="wow fadeInDown" data-wow-delay="0.5s"><a class="{{ Request::is('novioglas') ? 'active' : '' }}" href="{{ route('novioglas') }}">Novi Oglas</a></li>
                <li class="wow fadeInDown" data-wow-delay="0.5s"><a class="{{ Request::is('profil') || !empty($novioglas) ? 'active' : '' }}" href="{{ route('profil') }}">Profil</a></li>
              @endif
            </ul>
          @endif
        </div><!-- /.navbar-collapse -->
    ...
    <div class="content-area">
      <div class="container">
        ...
        @if(Auth::check() && Auth::user()->role == 'admin')
          <p>Ulogovani ste kao: <b>{{ Auth::user()->name }} (Administrator)</b></p>
        @endif
